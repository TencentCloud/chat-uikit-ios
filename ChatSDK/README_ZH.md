...
此外，我们还提供了 C 接口和 C++ 接口的 SDK，您可以从这里下载：[下载 C API 版本](https://im.sdk.qcloud.com/download/plus/8.6.7040/cross_platform/ImSDK_iOS_C_8.6.7040.framework.zip)、[下载 C++ API 版本](https://im.sdk.qcloud.com/download/plus/8.6.7040/cross_platform/ImSDK_iOS_CPP_8.6.7040.framework.zip)。
